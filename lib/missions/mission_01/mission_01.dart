...
class Mission_01 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // App Bar with back button for landing page
      appBar: AppBar(
        leading: IconButton(
  ...
  // Start of Mission Button Widget
    ...
    return Center(
      child: GestureDetector(
        ...
        onTapUp: (_) {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const Mission01Observe()),
          );
        },
        child: Container(
