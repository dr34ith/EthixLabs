...
class AppColors {
  ...
  static const Color crimsonBright = Color(0xFFD32F2F); // for glows
  static const Color crimsonDark = Color(0xFF5A0000);
  static const Color crimsonGlow = Color(0xFFFF1744); // pure red for glow effects

  // ── Backgrounds ──
  static const Color bgPrimary = Color(0xFF0A0A1A);
  static const Color bgCard = Color(0xFF1A1A2E);
  static const Color bgCardElevated = Color(0xFF22223A);
  static const Color bgOverlay = Color(0xFF12121F);

  // ── Borders ──
  static const Color borderSubtle = Color(0xFF2A2A3E);
  static const Color borderMedium = Color(0xFF3A3A4E);
  ...
  // ── Legacy aliases ──
  // Kept byte-identical to the original lib/theme.dart values so every
  // screen built before this design-system unification keeps rendering
  // exactly as before. New code should use the named colors above instead
  // of these; migrate a screen off these aliases when it's next touched.
  static const Color background = Color(0xFF121016);
  static const Color surface = Color(0xFF1E1E2A);
  static const Color card = Color(0xFF22151A);
...
/// Text/button colors for screens with a light background — the mission
/// stage screens render over a light `missions_BG.png` image, so the
/// app's usual light-on-dark text (white, light crimson, etc.) is
/// unreadable there. Use these instead on any light-background screen.
class AppColorsOnLight {
  AppColorsOnLight._();

  static const Color bodyText = Color(0xFF1A1A2E); // dark navy — main text
  static const Color sectionLabel = Color(0xFF8B0000); // crimson — section labels, kept for branding
  static const Color bulletText = Color(0xFF2C2C3E); // dark charcoal — bullets and lists
  static const Color mutedText = Color(0xFF5A5A6E); // medium gray — muted text (subtitles, captions)
  static const Color buttonBg = Color(0xFF8B0000); // crimson — button backgrounds
