...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _loadData() {
    ...
    _userName = HiveService.getDisplayName();
    _completed = summary['completedMissions'] as int? ?? 0;
    _flags = summary['flags'] as int? ?? 0;
  }
    ...
    return Scaffold(
      ...
      body: SizedBox.expand(
        child: Stack(
          children: [
            Positioned.fill(
              child: Image.asset('assets/images/bg3_noLogo.jpg', fit: BoxFit.cover),
            ),
            Positioned.fill(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(child: _statCard('Flags Earned', '$_flags', Icons.flag, sw)),
                      ],
                    ),
                    SizedBox(height: vs),
                    Row(
                      children: [
                        Expanded(child: _statCard('Total Points', '${_flags * 100}', Icons.star, sw)),
                        SizedBox(width: sw * 0.03),
                        Expanded(child: _statCard('Rank', _getRank(), Icons.emoji_events, sw)),
                      ],
                    ),
                    SizedBox(height: vs * 1.5),
  ...
  Widget _statCard(String title, String value, IconData icon, double sw) {
    return Container(
